...
abstract class Assets {
	...
	public static function get_styles() {
		...
		return apply_filters( 'above_the_fold_audit_enqueue_styles', array() );
	}
	...
	public static function get_scripts() {
		...
		return apply_filters( 'above_the_fold_audit_enqueue_scripts', array() );
	}
	...
	public static function load_scripts() {
		...
		if ( ! did_action( 'before_above_the_fold_audit_init' ) ) {
			return;
		}
